...
"
        ...
        :right-side-bar/recent "История просмотра"
        :right-side-bar/contents "Contents"
        :right-side-bar/graph-ref "Граф страницы "
        ...
        :reference/unlinked-ref "Непривязанные ссылки"
        ...
        :page/show-journals "Показывать журналы"
